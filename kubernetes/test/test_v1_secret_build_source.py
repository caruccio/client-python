...
from kubernetes.client.models.v1_secret_build_source import V1SecretBuildSource
...
class TestV1SecretBuildSource(unittest.TestCase):
    ...
    def testV1SecretBuildSource(self):
        ...
        """
        model = kubernetes.client.models.v1_secret_build_source.V1SecretBuildSource()
