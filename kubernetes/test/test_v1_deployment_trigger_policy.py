...
from kubernetes.client.models.v1_deployment_trigger_policy import V1DeploymentTriggerPolicy
...
class TestV1DeploymentTriggerPolicy(unittest.TestCase):
    ...
    def testV1DeploymentTriggerPolicy(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_trigger_policy.V1DeploymentTriggerPolicy()
