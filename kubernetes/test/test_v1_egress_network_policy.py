...
from kubernetes.client.models.v1_egress_network_policy import V1EgressNetworkPolicy
...
class TestV1EgressNetworkPolicy(unittest.TestCase):
    ...
    def testV1EgressNetworkPolicy(self):
        ...
        """
        model = kubernetes.client.models.v1_egress_network_policy.V1EgressNetworkPolicy()
