...
from kubernetes.client.models.v1_recreate_deployment_strategy_params import V1RecreateDeploymentStrategyParams
...
class TestV1RecreateDeploymentStrategyParams(unittest.TestCase):
    ...
    def testV1RecreateDeploymentStrategyParams(self):
        ...
        """
        model = kubernetes.client.models.v1_recreate_deployment_strategy_params.V1RecreateDeploymentStrategyParams()
