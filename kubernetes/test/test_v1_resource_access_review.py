...
from kubernetes.client.models.v1_resource_access_review import V1ResourceAccessReview
...
class TestV1ResourceAccessReview(unittest.TestCase):
    ...
    def testV1ResourceAccessReview(self):
        ...
        """
        model = kubernetes.client.models.v1_resource_access_review.V1ResourceAccessReview()
