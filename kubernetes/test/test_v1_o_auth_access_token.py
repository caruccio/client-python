...
from kubernetes.client.models.v1_o_auth_access_token import V1OAuthAccessToken
...
class TestV1OAuthAccessToken(unittest.TestCase):
    ...
    def testV1OAuthAccessToken(self):
        ...
        """
        model = kubernetes.client.models.v1_o_auth_access_token.V1OAuthAccessToken()
