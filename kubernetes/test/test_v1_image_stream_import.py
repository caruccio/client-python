...
from kubernetes.client.models.v1_image_stream_import import V1ImageStreamImport
...
class TestV1ImageStreamImport(unittest.TestCase):
    ...
    def testV1ImageStreamImport(self):
        ...
        """
        model = kubernetes.client.models.v1_image_stream_import.V1ImageStreamImport()
