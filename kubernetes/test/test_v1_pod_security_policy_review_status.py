...
from kubernetes.client.models.v1_pod_security_policy_review_status import V1PodSecurityPolicyReviewStatus
...
class TestV1PodSecurityPolicyReviewStatus(unittest.TestCase):
    ...
    def testV1PodSecurityPolicyReviewStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_pod_security_policy_review_status.V1PodSecurityPolicyReviewStatus()
