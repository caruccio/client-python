...
from kubernetes.client.models.v1_git_hub_web_hook_cause import V1GitHubWebHookCause
...
class TestV1GitHubWebHookCause(unittest.TestCase):
    ...
    def testV1GitHubWebHookCause(self):
        ...
        """
        model = kubernetes.client.models.v1_git_hub_web_hook_cause.V1GitHubWebHookCause()
