...
from kubernetes.client.models.v1_deployment_config_list import V1DeploymentConfigList
...
class TestV1DeploymentConfigList(unittest.TestCase):
    ...
    def testV1DeploymentConfigList(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_config_list.V1DeploymentConfigList()
