...
from kubernetes.client.models.v1_o_auth_client_authorization_list import V1OAuthClientAuthorizationList
...
class TestV1OAuthClientAuthorizationList(unittest.TestCase):
    ...
    def testV1OAuthClientAuthorizationList(self):
        ...
        """
        model = kubernetes.client.models.v1_o_auth_client_authorization_list.V1OAuthClientAuthorizationList()
