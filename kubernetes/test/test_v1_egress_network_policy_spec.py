...
from kubernetes.client.models.v1_egress_network_policy_spec import V1EgressNetworkPolicySpec
...
class TestV1EgressNetworkPolicySpec(unittest.TestCase):
    ...
    def testV1EgressNetworkPolicySpec(self):
        ...
        """
        model = kubernetes.client.models.v1_egress_network_policy_spec.V1EgressNetworkPolicySpec()
