...
from kubernetes.client.models.v1_deployment_config_rollback import V1DeploymentConfigRollback
...
class TestV1DeploymentConfigRollback(unittest.TestCase):
    ...
    def testV1DeploymentConfigRollback(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_config_rollback.V1DeploymentConfigRollback()
