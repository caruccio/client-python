...
from kubernetes.client.models.v1_user_identity_mapping import V1UserIdentityMapping
...
class TestV1UserIdentityMapping(unittest.TestCase):
    ...
    def testV1UserIdentityMapping(self):
        ...
        """
        model = kubernetes.client.models.v1_user_identity_mapping.V1UserIdentityMapping()
