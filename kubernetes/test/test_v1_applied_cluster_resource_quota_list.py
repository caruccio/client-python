...
from kubernetes.client.models.v1_applied_cluster_resource_quota_list import V1AppliedClusterResourceQuotaList
...
class TestV1AppliedClusterResourceQuotaList(unittest.TestCase):
    ...
    def testV1AppliedClusterResourceQuotaList(self):
        ...
        """
        model = kubernetes.client.models.v1_applied_cluster_resource_quota_list.V1AppliedClusterResourceQuotaList()
