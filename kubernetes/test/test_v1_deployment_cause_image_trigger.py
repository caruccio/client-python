...
from kubernetes.client.models.v1_deployment_cause_image_trigger import V1DeploymentCauseImageTrigger
...
class TestV1DeploymentCauseImageTrigger(unittest.TestCase):
    ...
    def testV1DeploymentCauseImageTrigger(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_cause_image_trigger.V1DeploymentCauseImageTrigger()
