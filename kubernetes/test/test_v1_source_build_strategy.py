...
from kubernetes.client.models.v1_source_build_strategy import V1SourceBuildStrategy
...
class TestV1SourceBuildStrategy(unittest.TestCase):
    ...
    def testV1SourceBuildStrategy(self):
        ...
        """
        model = kubernetes.client.models.v1_source_build_strategy.V1SourceBuildStrategy()
