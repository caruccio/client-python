...
from kubernetes.client.models.v1_deployment_details import V1DeploymentDetails
...
class TestV1DeploymentDetails(unittest.TestCase):
    ...
    def testV1DeploymentDetails(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_details.V1DeploymentDetails()
