...
from kubernetes.client.models.v1_role_binding_restriction_list import V1RoleBindingRestrictionList
...
class TestV1RoleBindingRestrictionList(unittest.TestCase):
    ...
    def testV1RoleBindingRestrictionList(self):
        ...
        """
        model = kubernetes.client.models.v1_role_binding_restriction_list.V1RoleBindingRestrictionList()
