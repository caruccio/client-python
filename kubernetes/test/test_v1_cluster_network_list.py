...
from kubernetes.client.models.v1_cluster_network_list import V1ClusterNetworkList
...
class TestV1ClusterNetworkList(unittest.TestCase):
    ...
    def testV1ClusterNetworkList(self):
        ...
        """
        model = kubernetes.client.models.v1_cluster_network_list.V1ClusterNetworkList()
