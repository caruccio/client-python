...
from kubernetes.client.models.v1_deprecated_downward_api_volume_source import V1DeprecatedDownwardAPIVolumeSource
...
class TestV1DeprecatedDownwardAPIVolumeSource(unittest.TestCase):
    ...
    def testV1DeprecatedDownwardAPIVolumeSource(self):
        ...
        """
        model = kubernetes.client.models.v1_deprecated_downward_api_volume_source.V1DeprecatedDownwardAPIVolumeSource()
