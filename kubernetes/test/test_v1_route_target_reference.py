...
from kubernetes.client.models.v1_route_target_reference import V1RouteTargetReference
...
class TestV1RouteTargetReference(unittest.TestCase):
    ...
    def testV1RouteTargetReference(self):
        ...
        """
        model = kubernetes.client.models.v1_route_target_reference.V1RouteTargetReference()
