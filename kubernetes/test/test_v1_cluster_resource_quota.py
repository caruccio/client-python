...
from kubernetes.client.models.v1_cluster_resource_quota import V1ClusterResourceQuota
...
class TestV1ClusterResourceQuota(unittest.TestCase):
    ...
    def testV1ClusterResourceQuota(self):
        ...
        """
        model = kubernetes.client.models.v1_cluster_resource_quota.V1ClusterResourceQuota()
