...
from kubernetes.client.models.v1_se_linux_context_strategy_options import V1SELinuxContextStrategyOptions
...
class TestV1SELinuxContextStrategyOptions(unittest.TestCase):
    ...
    def testV1SELinuxContextStrategyOptions(self):
        ...
        """
        model = kubernetes.client.models.v1_se_linux_context_strategy_options.V1SELinuxContextStrategyOptions()
