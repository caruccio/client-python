...
from kubernetes.client.models.v1_binary_build_source import V1BinaryBuildSource
...
class TestV1BinaryBuildSource(unittest.TestCase):
    ...
    def testV1BinaryBuildSource(self):
        ...
        """
        model = kubernetes.client.models.v1_binary_build_source.V1BinaryBuildSource()
