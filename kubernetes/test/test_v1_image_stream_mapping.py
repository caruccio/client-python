...
from kubernetes.client.models.v1_image_stream_mapping import V1ImageStreamMapping
...
class TestV1ImageStreamMapping(unittest.TestCase):
    ...
    def testV1ImageStreamMapping(self):
        ...
        """
        model = kubernetes.client.models.v1_image_stream_mapping.V1ImageStreamMapping()
