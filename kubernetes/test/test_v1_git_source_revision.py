...
from kubernetes.client.models.v1_git_source_revision import V1GitSourceRevision
...
class TestV1GitSourceRevision(unittest.TestCase):
    ...
    def testV1GitSourceRevision(self):
        ...
        """
        model = kubernetes.client.models.v1_git_source_revision.V1GitSourceRevision()
