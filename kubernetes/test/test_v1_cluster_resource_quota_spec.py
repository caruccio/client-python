...
from kubernetes.client.models.v1_cluster_resource_quota_spec import V1ClusterResourceQuotaSpec
...
class TestV1ClusterResourceQuotaSpec(unittest.TestCase):
    ...
    def testV1ClusterResourceQuotaSpec(self):
        ...
        """
        model = kubernetes.client.models.v1_cluster_resource_quota_spec.V1ClusterResourceQuotaSpec()
