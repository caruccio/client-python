...
from kubernetes.client.models.v1_build_status_output_to import V1BuildStatusOutputTo
...
class TestV1BuildStatusOutputTo(unittest.TestCase):
    ...
    def testV1BuildStatusOutputTo(self):
        ...
        """
        model = kubernetes.client.models.v1_build_status_output_to.V1BuildStatusOutputTo()
