...
from kubernetes.client.models.v1_build_post_commit_spec import V1BuildPostCommitSpec
...
class TestV1BuildPostCommitSpec(unittest.TestCase):
    ...
    def testV1BuildPostCommitSpec(self):
        ...
        """
        model = kubernetes.client.models.v1_build_post_commit_spec.V1BuildPostCommitSpec()
