...
from kubernetes.client.models.v1_repository_import_spec import V1RepositoryImportSpec
...
class TestV1RepositoryImportSpec(unittest.TestCase):
    ...
    def testV1RepositoryImportSpec(self):
        ...
        """
        model = kubernetes.client.models.v1_repository_import_spec.V1RepositoryImportSpec()
