...
from kubernetes.client.models.v1_image_import_status import V1ImageImportStatus
...
class TestV1ImageImportStatus(unittest.TestCase):
    ...
    def testV1ImageImportStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_image_import_status.V1ImageImportStatus()
