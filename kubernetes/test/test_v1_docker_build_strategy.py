...
from kubernetes.client.models.v1_docker_build_strategy import V1DockerBuildStrategy
...
class TestV1DockerBuildStrategy(unittest.TestCase):
    ...
    def testV1DockerBuildStrategy(self):
        ...
        """
        model = kubernetes.client.models.v1_docker_build_strategy.V1DockerBuildStrategy()
