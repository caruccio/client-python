...
from kubernetes.client.models.v1_pod_security_policy_subject_review import V1PodSecurityPolicySubjectReview
...
class TestV1PodSecurityPolicySubjectReview(unittest.TestCase):
    ...
    def testV1PodSecurityPolicySubjectReview(self):
        ...
        """
        model = kubernetes.client.models.v1_pod_security_policy_subject_review.V1PodSecurityPolicySubjectReview()
