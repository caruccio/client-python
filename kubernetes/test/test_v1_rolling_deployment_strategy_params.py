...
from kubernetes.client.models.v1_rolling_deployment_strategy_params import V1RollingDeploymentStrategyParams
...
class TestV1RollingDeploymentStrategyParams(unittest.TestCase):
    ...
    def testV1RollingDeploymentStrategyParams(self):
        ...
        """
        model = kubernetes.client.models.v1_rolling_deployment_strategy_params.V1RollingDeploymentStrategyParams()
