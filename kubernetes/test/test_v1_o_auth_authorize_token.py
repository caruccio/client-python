...
from kubernetes.client.models.v1_o_auth_authorize_token import V1OAuthAuthorizeToken
...
class TestV1OAuthAuthorizeToken(unittest.TestCase):
    ...
    def testV1OAuthAuthorizeToken(self):
        ...
        """
        model = kubernetes.client.models.v1_o_auth_authorize_token.V1OAuthAuthorizeToken()
