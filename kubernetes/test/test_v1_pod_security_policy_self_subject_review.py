...
from kubernetes.client.models.v1_pod_security_policy_self_subject_review import V1PodSecurityPolicySelfSubjectReview
...
class TestV1PodSecurityPolicySelfSubjectReview(unittest.TestCase):
    ...
    def testV1PodSecurityPolicySelfSubjectReview(self):
        ...
        """
        model = kubernetes.client.models.v1_pod_security_policy_self_subject_review.V1PodSecurityPolicySelfSubjectReview()
