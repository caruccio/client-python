...
from kubernetes.client.models.v1_named_tag_event_list import V1NamedTagEventList
...
class TestV1NamedTagEventList(unittest.TestCase):
    ...
    def testV1NamedTagEventList(self):
        ...
        """
        model = kubernetes.client.models.v1_named_tag_event_list.V1NamedTagEventList()
