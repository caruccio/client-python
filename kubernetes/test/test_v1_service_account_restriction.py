...
from kubernetes.client.models.v1_service_account_restriction import V1ServiceAccountRestriction
...
class TestV1ServiceAccountRestriction(unittest.TestCase):
    ...
    def testV1ServiceAccountRestriction(self):
        ...
        """
        model = kubernetes.client.models.v1_service_account_restriction.V1ServiceAccountRestriction()
