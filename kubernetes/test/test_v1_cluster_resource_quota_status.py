...
from kubernetes.client.models.v1_cluster_resource_quota_status import V1ClusterResourceQuotaStatus
...
class TestV1ClusterResourceQuotaStatus(unittest.TestCase):
    ...
    def testV1ClusterResourceQuotaStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_cluster_resource_quota_status.V1ClusterResourceQuotaStatus()
