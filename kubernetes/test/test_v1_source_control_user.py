...
from kubernetes.client.models.v1_source_control_user import V1SourceControlUser
...
class TestV1SourceControlUser(unittest.TestCase):
    ...
    def testV1SourceControlUser(self):
        ...
        """
        model = kubernetes.client.models.v1_source_control_user.V1SourceControlUser()
