...
from kubernetes.client.models.v1_tag_reference_policy import V1TagReferencePolicy
...
class TestV1TagReferencePolicy(unittest.TestCase):
    ...
    def testV1TagReferencePolicy(self):
        ...
        """
        model = kubernetes.client.models.v1_tag_reference_policy.V1TagReferencePolicy()
