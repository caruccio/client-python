...
from kubernetes.client.models.v1_signature_condition import V1SignatureCondition
...
class TestV1SignatureCondition(unittest.TestCase):
    ...
    def testV1SignatureCondition(self):
        ...
        """
        model = kubernetes.client.models.v1_signature_condition.V1SignatureCondition()
