...
from kubernetes.client.models.v1_pod_security_policy_review import V1PodSecurityPolicyReview
...
class TestV1PodSecurityPolicyReview(unittest.TestCase):
    ...
    def testV1PodSecurityPolicyReview(self):
        ...
        """
        model = kubernetes.client.models.v1_pod_security_policy_review.V1PodSecurityPolicyReview()
