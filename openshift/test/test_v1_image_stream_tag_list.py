...
from kubernetes.client.models.v1_image_stream_tag_list import V1ImageStreamTagList
...
class TestV1ImageStreamTagList(unittest.TestCase):
    ...
    def testV1ImageStreamTagList(self):
        ...
        """
        model = kubernetes.client.models.v1_image_stream_tag_list.V1ImageStreamTagList()
