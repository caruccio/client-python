...
from kubernetes.client.models.v1_fs_group_strategy_options import V1FSGroupStrategyOptions
...
class TestV1FSGroupStrategyOptions(unittest.TestCase):
    ...
    def testV1FSGroupStrategyOptions(self):
        ...
        """
        model = kubernetes.client.models.v1_fs_group_strategy_options.V1FSGroupStrategyOptions()
