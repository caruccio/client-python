...
from kubernetes.client.models.v1_image_stream_import_spec import V1ImageStreamImportSpec
...
class TestV1ImageStreamImportSpec(unittest.TestCase):
    ...
    def testV1ImageStreamImportSpec(self):
        ...
        """
        model = kubernetes.client.models.v1_image_stream_import_spec.V1ImageStreamImportSpec()
