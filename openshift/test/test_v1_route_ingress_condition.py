...
from kubernetes.client.models.v1_route_ingress_condition import V1RouteIngressCondition
...
class TestV1RouteIngressCondition(unittest.TestCase):
    ...
    def testV1RouteIngressCondition(self):
        ...
        """
        model = kubernetes.client.models.v1_route_ingress_condition.V1RouteIngressCondition()
