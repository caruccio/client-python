...
from kubernetes.client.models.v1_role_binding_restriction import V1RoleBindingRestriction
...
class TestV1RoleBindingRestriction(unittest.TestCase):
    ...
    def testV1RoleBindingRestriction(self):
        ...
        """
        model = kubernetes.client.models.v1_role_binding_restriction.V1RoleBindingRestriction()
