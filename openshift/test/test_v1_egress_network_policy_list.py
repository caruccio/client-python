...
from kubernetes.client.models.v1_egress_network_policy_list import V1EgressNetworkPolicyList
...
class TestV1EgressNetworkPolicyList(unittest.TestCase):
    ...
    def testV1EgressNetworkPolicyList(self):
        ...
        """
        model = kubernetes.client.models.v1_egress_network_policy_list.V1EgressNetworkPolicyList()
