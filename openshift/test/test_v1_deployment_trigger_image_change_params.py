...
from kubernetes.client.models.v1_deployment_trigger_image_change_params import V1DeploymentTriggerImageChangeParams
...
class TestV1DeploymentTriggerImageChangeParams(unittest.TestCase):
    ...
    def testV1DeploymentTriggerImageChangeParams(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_trigger_image_change_params.V1DeploymentTriggerImageChangeParams()
