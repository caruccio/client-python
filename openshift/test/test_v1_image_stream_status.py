...
from kubernetes.client.models.v1_image_stream_status import V1ImageStreamStatus
...
class TestV1ImageStreamStatus(unittest.TestCase):
    ...
    def testV1ImageStreamStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_image_stream_status.V1ImageStreamStatus()
