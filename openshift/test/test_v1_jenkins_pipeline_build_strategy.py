...
from kubernetes.client.models.v1_jenkins_pipeline_build_strategy import V1JenkinsPipelineBuildStrategy
...
class TestV1JenkinsPipelineBuildStrategy(unittest.TestCase):
    ...
    def testV1JenkinsPipelineBuildStrategy(self):
        ...
        """
        model = kubernetes.client.models.v1_jenkins_pipeline_build_strategy.V1JenkinsPipelineBuildStrategy()
