...
from kubernetes.client.models.v1_custom_build_strategy import V1CustomBuildStrategy
...
class TestV1CustomBuildStrategy(unittest.TestCase):
    ...
    def testV1CustomBuildStrategy(self):
        ...
        """
        model = kubernetes.client.models.v1_custom_build_strategy.V1CustomBuildStrategy()
