...
from kubernetes.client.models.v1_resource_quota_status_by_namespace import V1ResourceQuotaStatusByNamespace
...
class TestV1ResourceQuotaStatusByNamespace(unittest.TestCase):
    ...
    def testV1ResourceQuotaStatusByNamespace(self):
        ...
        """
        model = kubernetes.client.models.v1_resource_quota_status_by_namespace.V1ResourceQuotaStatusByNamespace()
