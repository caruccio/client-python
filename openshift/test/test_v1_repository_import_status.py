...
from kubernetes.client.models.v1_repository_import_status import V1RepositoryImportStatus
...
class TestV1RepositoryImportStatus(unittest.TestCase):
    ...
    def testV1RepositoryImportStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_repository_import_status.V1RepositoryImportStatus()
