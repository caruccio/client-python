...
from kubernetes.client.models.v1_applied_cluster_resource_quota import V1AppliedClusterResourceQuota
...
class TestV1AppliedClusterResourceQuota(unittest.TestCase):
    ...
    def testV1AppliedClusterResourceQuota(self):
        ...
        """
        model = kubernetes.client.models.v1_applied_cluster_resource_quota.V1AppliedClusterResourceQuota()
