...
from kubernetes.client.models.v1_image_change_trigger import V1ImageChangeTrigger
...
class TestV1ImageChangeTrigger(unittest.TestCase):
    ...
    def testV1ImageChangeTrigger(self):
        ...
        """
        model = kubernetes.client.models.v1_image_change_trigger.V1ImageChangeTrigger()
