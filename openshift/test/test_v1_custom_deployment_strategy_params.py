...
from kubernetes.client.models.v1_custom_deployment_strategy_params import V1CustomDeploymentStrategyParams
...
class TestV1CustomDeploymentStrategyParams(unittest.TestCase):
    ...
    def testV1CustomDeploymentStrategyParams(self):
        ...
        """
        model = kubernetes.client.models.v1_custom_deployment_strategy_params.V1CustomDeploymentStrategyParams()
