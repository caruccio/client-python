...
from kubernetes.client.models.v1_role_binding_restriction_spec import V1RoleBindingRestrictionSpec
...
class TestV1RoleBindingRestrictionSpec(unittest.TestCase):
    ...
    def testV1RoleBindingRestrictionSpec(self):
        ...
        """
        model = kubernetes.client.models.v1_role_binding_restriction_spec.V1RoleBindingRestrictionSpec()
