...
from kubernetes.client.models.v1_security_context_constraints import V1SecurityContextConstraints
...
class TestV1SecurityContextConstraints(unittest.TestCase):
    ...
    def testV1SecurityContextConstraints(self):
        ...
        """
        model = kubernetes.client.models.v1_security_context_constraints.V1SecurityContextConstraints()
