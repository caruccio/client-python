...
from kubernetes.client.models.v1_build_config_status import V1BuildConfigStatus
...
class TestV1BuildConfigStatus(unittest.TestCase):
    ...
    def testV1BuildConfigStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_build_config_status.V1BuildConfigStatus()
