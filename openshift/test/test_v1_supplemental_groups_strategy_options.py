...
from kubernetes.client.models.v1_supplemental_groups_strategy_options import V1SupplementalGroupsStrategyOptions
...
class TestV1SupplementalGroupsStrategyOptions(unittest.TestCase):
    ...
    def testV1SupplementalGroupsStrategyOptions(self):
        ...
        """
        model = kubernetes.client.models.v1_supplemental_groups_strategy_options.V1SupplementalGroupsStrategyOptions()
