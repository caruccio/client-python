...
from kubernetes.client.models.v1_pod_security_policy_review_spec import V1PodSecurityPolicyReviewSpec
...
class TestV1PodSecurityPolicyReviewSpec(unittest.TestCase):
    ...
    def testV1PodSecurityPolicyReviewSpec(self):
        ...
        """
        model = kubernetes.client.models.v1_pod_security_policy_review_spec.V1PodSecurityPolicyReviewSpec()
