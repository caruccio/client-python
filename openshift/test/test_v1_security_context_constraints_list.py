...
from kubernetes.client.models.v1_security_context_constraints_list import V1SecurityContextConstraintsList
...
class TestV1SecurityContextConstraintsList(unittest.TestCase):
    ...
    def testV1SecurityContextConstraintsList(self):
        ...
        """
        model = kubernetes.client.models.v1_security_context_constraints_list.V1SecurityContextConstraintsList()
