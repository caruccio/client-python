...
from kubernetes.client.models.v1_subject_rules_review import V1SubjectRulesReview
...
class TestV1SubjectRulesReview(unittest.TestCase):
    ...
    def testV1SubjectRulesReview(self):
        ...
        """
        model = kubernetes.client.models.v1_subject_rules_review.V1SubjectRulesReview()
