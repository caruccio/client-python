...
from kubernetes.client.models.v1_image_stream_import_status import V1ImageStreamImportStatus
...
class TestV1ImageStreamImportStatus(unittest.TestCase):
    ...
    def testV1ImageStreamImportStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_image_stream_import_status.V1ImageStreamImportStatus()
