...
from kubernetes.client.models.v1_run_as_user_strategy_options import V1RunAsUserStrategyOptions
...
class TestV1RunAsUserStrategyOptions(unittest.TestCase):
    ...
    def testV1RunAsUserStrategyOptions(self):
        ...
        """
        model = kubernetes.client.models.v1_run_as_user_strategy_options.V1RunAsUserStrategyOptions()
