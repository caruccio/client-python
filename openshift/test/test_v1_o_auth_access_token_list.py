...
from kubernetes.client.models.v1_o_auth_access_token_list import V1OAuthAccessTokenList
...
class TestV1OAuthAccessTokenList(unittest.TestCase):
    ...
    def testV1OAuthAccessTokenList(self):
        ...
        """
        model = kubernetes.client.models.v1_o_auth_access_token_list.V1OAuthAccessTokenList()
