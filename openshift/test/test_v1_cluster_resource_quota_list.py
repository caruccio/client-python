...
from kubernetes.client.models.v1_cluster_resource_quota_list import V1ClusterResourceQuotaList
...
class TestV1ClusterResourceQuotaList(unittest.TestCase):
    ...
    def testV1ClusterResourceQuotaList(self):
        ...
        """
        model = kubernetes.client.models.v1_cluster_resource_quota_list.V1ClusterResourceQuotaList()
