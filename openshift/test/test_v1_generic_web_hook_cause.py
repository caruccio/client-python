...
from kubernetes.client.models.v1_generic_web_hook_cause import V1GenericWebHookCause
...
class TestV1GenericWebHookCause(unittest.TestCase):
    ...
    def testV1GenericWebHookCause(self):
        ...
        """
        model = kubernetes.client.models.v1_generic_web_hook_cause.V1GenericWebHookCause()
