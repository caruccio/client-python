...
from kubernetes.client.models.v1_build_status_output import V1BuildStatusOutput
...
class TestV1BuildStatusOutput(unittest.TestCase):
    ...
    def testV1BuildStatusOutput(self):
        ...
        """
        model = kubernetes.client.models.v1_build_status_output.V1BuildStatusOutput()
