...
from kubernetes.client.models.v1_service_account_pod_security_policy_review_status import V1ServiceAccountPodSecurityPolicyReviewStatus
...
class TestV1ServiceAccountPodSecurityPolicyReviewStatus(unittest.TestCase):
    ...
    def testV1ServiceAccountPodSecurityPolicyReviewStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_service_account_pod_security_policy_review_status.V1ServiceAccountPodSecurityPolicyReviewStatus()
