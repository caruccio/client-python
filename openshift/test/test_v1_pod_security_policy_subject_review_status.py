...
from kubernetes.client.models.v1_pod_security_policy_subject_review_status import V1PodSecurityPolicySubjectReviewStatus
...
class TestV1PodSecurityPolicySubjectReviewStatus(unittest.TestCase):
    ...
    def testV1PodSecurityPolicySubjectReviewStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_pod_security_policy_subject_review_status.V1PodSecurityPolicySubjectReviewStatus()
