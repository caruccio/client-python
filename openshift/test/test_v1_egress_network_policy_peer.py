...
from kubernetes.client.models.v1_egress_network_policy_peer import V1EgressNetworkPolicyPeer
...
class TestV1EgressNetworkPolicyPeer(unittest.TestCase):
    ...
    def testV1EgressNetworkPolicyPeer(self):
        ...
        """
        model = kubernetes.client.models.v1_egress_network_policy_peer.V1EgressNetworkPolicyPeer()
