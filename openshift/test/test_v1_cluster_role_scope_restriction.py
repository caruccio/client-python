...
from kubernetes.client.models.v1_cluster_role_scope_restriction import V1ClusterRoleScopeRestriction
...
class TestV1ClusterRoleScopeRestriction(unittest.TestCase):
    ...
    def testV1ClusterRoleScopeRestriction(self):
        ...
        """
        model = kubernetes.client.models.v1_cluster_role_scope_restriction.V1ClusterRoleScopeRestriction()
