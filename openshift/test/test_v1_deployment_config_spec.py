...
from kubernetes.client.models.v1_deployment_config_spec import V1DeploymentConfigSpec
...
class TestV1DeploymentConfigSpec(unittest.TestCase):
    ...
    def testV1DeploymentConfigSpec(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_config_spec.V1DeploymentConfigSpec()
