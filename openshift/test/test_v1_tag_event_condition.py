...
from kubernetes.client.models.v1_tag_event_condition import V1TagEventCondition
...
class TestV1TagEventCondition(unittest.TestCase):
    ...
    def testV1TagEventCondition(self):
        ...
        """
        model = kubernetes.client.models.v1_tag_event_condition.V1TagEventCondition()
