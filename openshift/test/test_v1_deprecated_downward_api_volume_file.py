...
from kubernetes.client.models.v1_deprecated_downward_api_volume_file import V1DeprecatedDownwardAPIVolumeFile
...
class TestV1DeprecatedDownwardAPIVolumeFile(unittest.TestCase):
    ...
    def testV1DeprecatedDownwardAPIVolumeFile(self):
        ...
        """
        model = kubernetes.client.models.v1_deprecated_downward_api_volume_file.V1DeprecatedDownwardAPIVolumeFile()
