...
from kubernetes.client.models.v1_o_auth_client_authorization import V1OAuthClientAuthorization
...
class TestV1OAuthClientAuthorization(unittest.TestCase):
    ...
    def testV1OAuthClientAuthorization(self):
        ...
        """
        model = kubernetes.client.models.v1_o_auth_client_authorization.V1OAuthClientAuthorization()
