...
from kubernetes.client.models.v1_deployment_request import V1DeploymentRequest
...
class TestV1DeploymentRequest(unittest.TestCase):
    ...
    def testV1DeploymentRequest(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_request.V1DeploymentRequest()
