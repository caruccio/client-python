...
from kubernetes.client.models.v1_service_account_reference import V1ServiceAccountReference
...
class TestV1ServiceAccountReference(unittest.TestCase):
    ...
    def testV1ServiceAccountReference(self):
        ...
        """
        model = kubernetes.client.models.v1_service_account_reference.V1ServiceAccountReference()
