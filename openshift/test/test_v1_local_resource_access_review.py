...
from kubernetes.client.models.v1_local_resource_access_review import V1LocalResourceAccessReview
...
class TestV1LocalResourceAccessReview(unittest.TestCase):
    ...
    def testV1LocalResourceAccessReview(self):
        ...
        """
        model = kubernetes.client.models.v1_local_resource_access_review.V1LocalResourceAccessReview()
