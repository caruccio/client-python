...
from kubernetes.client.models.v1_deployment_config_status import V1DeploymentConfigStatus
...
class TestV1DeploymentConfigStatus(unittest.TestCase):
    ...
    def testV1DeploymentConfigStatus(self):
        ...
        """
        model = kubernetes.client.models.v1_deployment_config_status.V1DeploymentConfigStatus()
