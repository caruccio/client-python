...
from kubernetes.client.models.v1_build_trigger_cause import V1BuildTriggerCause
...
class TestV1BuildTriggerCause(unittest.TestCase):
    ...
    def testV1BuildTriggerCause(self):
        ...
        """
        model = kubernetes.client.models.v1_build_trigger_cause.V1BuildTriggerCause()
