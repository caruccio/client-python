...
from kubernetes.client.models.v1_egress_network_policy_rule import V1EgressNetworkPolicyRule
...
class TestV1EgressNetworkPolicyRule(unittest.TestCase):
    ...
    def testV1EgressNetworkPolicyRule(self):
        ...
        """
        model = kubernetes.client.models.v1_egress_network_policy_rule.V1EgressNetworkPolicyRule()
